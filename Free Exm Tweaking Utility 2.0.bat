...
echo. ╚═════════════════════════════╝
echo.
curl -g -k -L -# -o "C:\exmfree\Exm_Free_Power_Plan_V2.pow" "https://cdn.discordapp.com/attachments/1116671831961763860/1191075275644084224/Exm_Free_Power_Plan_V2.pow?ex=65a41e4a&is=6591a94a&hm=b1be534b4844c7a2ddc6ba671a4e75560b1d961b42a642e3c5d65aa35f98a0f8&"
...
echo. ╚═════════════════════════════╝
echo.
curl -g -k -L -# -o "C:\exmfree\Exm_Free_Settings_V4.nip" "https://cdn.discordapp.com/attachments/1116671831961763860/1191397502302310552/Exm_Free_Settings_V4.nip?ex=65a54a63&is=6592d563&hm=ed2dd865ef8ac6a24a868fa0fe7de70e8dfcc57e06622b1f5ee70b32986e43d9&" 
timeout /t 1 /nobreak > NUL
cls
echo. %b% 
echo. ╔═════════════════════════════╗
...
echo.       %b%║══════════════════════════════════════════════════════════════════════════════════════════════════════════════════%b%║
echo.       %b%║%w%                                                                                                                  %b%║
echo.       %b%║%w%                                     Updated 30th December  *  Version 2.0                                        %b%║
echo.       %b%║%w%                                                                                                                  %b%║
echo.       %b%║══════════════════════════════════════════════════════════════════════════════════════════════════════════════════%b%║
echo.       %b%║%w%                                                                                                                  %b%║
